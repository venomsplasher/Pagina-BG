<template>
    <div class="mt-3">
        ...
        <b-row>
            <b-col>
                <b-input-group prepend="Nombre y Apellido" class="mt-3">
                    <b-form-input v-model="this.nombreyapellido"></b-form-input>
                </b-input-group>
            </b-col>
        </b-row>
        <b-row>
            <b-col>
                <b-input-group prepend="Telefono" class="mt-3">
                    <b-form-input v-model="this.telefono"></b-form-input>
                </b-input-group>
            </b-col>
            <b-col>
                <b-input-group prepend="E-mail" class="mt-3">
                    <b-form-input v-model="this.email"></b-form-input>
                </b-input-group>
            </b-col>
        </b-row>
        <b-row>
        ...
        <div  id="iconoscontacto" style="width:100%;padding-bottom:5%;padding-top:5%;">
            <a :href="'mailto:juansolo1988@gmail.com ?subject=Consulta%20Presupuesto%20para%20BG%20Computacion &body=BLABLABLA'+nombreyapellido">
